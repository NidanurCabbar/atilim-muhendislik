...
export const projects: Project[] = [
  ...
  },
  {
    ...
    aboutProject: 'Modern mimari anlayışıyla tasarlanan 365 AVM, bölgenin ticari yaşamına katkı sağlayan büyük ölçekli bir alışveriş merkezi projesidir.',
    status: 'completed',
    location: 'Ankara',
    area: '85.000 m²',
    year: '2019–2022',
    mapsUrl: 'https://maps.google.com/?q=360+AVM+Ankara',
    coverImage: '/images/projects/avm.png',
    gallery: [
      '/images/projects/avm.png',
    ],
    completedYear: 2022,
  },
  {
    ...
    coverImage: '/images/projects/odtu.png',
    gallery: [
      '/images/projects/odtu.png',
    ],
    completedYear: 2020,
  },
  {
