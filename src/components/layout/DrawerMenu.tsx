    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed inset-0 z-[70] bg-[#1a1a1a] flex flex-col"
        >
          <div className="flex flex-col h-full px-8 py-8 md:px-14 md:py-10">
            ...
            <div className="flex-1 grid md:grid-cols-2 gap-12 items-start">
              ...
              <div className="text-white space-y-8 order-2 md:order-1">
                ...
                <div>
                  <p className="text-[10px] tracking-[0.3em] text-white/40 uppercase mb-3 font-semibold">
                    Adres
                  </p>
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-white/60 hover:text-white transition text-sm block"
                  >
                    {contactInfo.phone1}
                  </a>
                  <a
                    href={`tel:${contactInfo.phone2.replace(/\s/g, '')}`}
                    className="text-white/60 hover:text-white transition text-sm block mt-1"
                  >
                    {contactInfo.phone2}
                  </a>
                </div>
              ...
              {/* Right — Navigation */}
              <nav className="order-1 md:order-2 flex justify-start md:justify-end items-start">
